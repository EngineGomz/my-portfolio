...
class ModernPortfolio {
  ...
  bindModalTriggers() {
    ...
    document.querySelectorAll('[data-modal="franksalt-modal"]').forEach(trigger => {
      trigger.addEventListener('click', (e) => {
        e.preventDefault();
        this.openModal('franksalt-modal');
      });
    });
  }
  ...
  //   const roles = ['Web Designer', 'UI/UX Designer', 'WordPress Developer'];
